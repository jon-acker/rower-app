...
describe ('module Rower.Metronome ->', function() {

    describe ('Rower.Metronome.start', function() {
    ...
    describe('Rower.Metronome.setSpeed()', function() {
        var _startTime;
    ...
    describe('Rower.Metronome.getLastTimestamp()', function() {    
